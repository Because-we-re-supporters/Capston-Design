...
$(document).ready(function() {
  ...
  var market_capitalization = $.ajax({
    url: "../static/data/market_capitalization.txt",
    dataType: 'text',
    success: function(data) {
  ...
  var exchangeRate = $.ajax({
    url: "../static/data/exchangeRate.txt",
    dataType: 'text',
    success: function(data) {
  ...
  var nationMarketRate = $.ajax({
    url: "../static/data/nationMarketRate.txt",
    dataType: 'text',
    success: function(data) {
